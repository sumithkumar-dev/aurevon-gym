...
Business logic will live in `features/member/` (the "notifications"
sub-area) — this route stays a thin entry point that renders components
from there.
