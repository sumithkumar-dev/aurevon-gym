...
import { getInvoicesForMember, type Invoice } from "@/lib/supabase/queries/invoices";
...
export default async function AdminMemberDetailPage({
  ...
  return (
    <div className="container-editorial py-16">
      ...
      <h1 className="mt-6 font-display text-display-2 uppercase text-foreground">
